...
export class CategoryService {
  ...
  findAll = async ({
    ...
    // const parentId1 = '66bccd1b2cd19298947c7b8b';

    // const catesLaptop: { name: string, description: string, isActive: boolean, parentId: string }[] = [
    //   {
    //     name: 'Laptop Gamming',
    //     description: 'Danh mục laptop theo Laptop Gamming',
    //     isActive: true,
    //     parentId: '66bccd1b2cd19298947c7b8b'
    //   },
    //   {
    //     name: 'Laptop Đồ họa',
    //     description: 'Danh mục laptop theo Laptop Đồ họa',
    //     isActive: true,
    //     parentId: '66bccd1b2cd19298947c7b8b'
    //   },
    //   {
    ...
    //   {
    //     name: 'Laptop Intel',
    //     description: 'Danh mục laptop theo Laptop Intel',
    //     isActive: true,
    //     parentId: '66bccd1b2cd19298947c7b8b'
    //   },
    //   {
    //     name: 'Laptop AMD',
    //     description: 'Danh mục laptop theo Laptop AMD',
    //     isActive: true,
    //     parentId: '66bccd1b2cd19298947c7b8b'
    //   },
    // ]

    // for (let cate of catesLaptop) {
    //   await this.categoryModel.create({
    //     ...cate,
    //     slug: this.transToSlug(cate.name)
    //   })
    // }
    ...
    return {
      message: 'OK',
      data: await this.categoryModel.find(query).select('name _id parentId')
